  ...
  <head>
    ...
    @keyframes slideInFromLeft {
     ...
     100% {
      ...
      animation: slideInFromLeft 1.5s 1;
      } 
      tr:nth-child(2){
  ...
  <body>
      ...
      <ul class="navbar-nav">
        <li class="logo">
          <a href="#" class="nav-link">
            <span class="link-text logo-text">RankLog</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
    ...
    <main>
      <div class="search-container">
       <h2>Rank Applicant</h2>
       <button class="view-link" onclick="makeRank()">Create New Rankings!</button>
       <div id="notifications"></div>
       <h3>Ranking History</h3>
      <!--Table -->
     <div style="width:100%"id="tableplaceholder"></div>
    </div>
    </main>
  </body>
</html>